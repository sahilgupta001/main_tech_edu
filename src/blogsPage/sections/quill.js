...
Font.whitelist = ['ubuntu', 'verdana', 'roboto', 'impact', 'courier', 'comic', 'times-new-roman'];
...
class QuillEditor extends React.Component {
    ...
    insertImage = (e) => {
        ...
        if (e.currentTarget && e.currentTarget.files && e.currentTarget.files.length > 0) {
            ...
            axios.post(BACKEND_URL + '/core/blog/uploadfiles', formData, config)
                .then(response => {
                    if (response.data.success) {
                        ...
                        quill.insertEmbed(position, "image", { src: BACKEND_URL + "/getfile/" + response.data.filename, alt: response.data.fileName });
    ...
    insertFile = (e) => {
        ...
        if (e.currentTarget && e.currentTarget.files && e.currentTarget.files.length > 0) {
            ...
            axios.post('/api/core/blog/uploadfiles', formData, config)
                .then(response => {
                    if (response.data.success) {
        ...
        return (
            <div>
                <div id="toolbar">
                    ...
                    <select className="ql-font" defaultValue={"times-new-roman"}  onChange={e => e.persist()} style = {{'width': "180px"}}>
